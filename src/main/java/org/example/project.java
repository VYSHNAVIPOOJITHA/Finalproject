...
public class project
{
    ...
    public static void browsercorrectcred()
    {
        ...
        driver.findElement(By.cssSelector("#login_field")).sendKeys("vyshnavitanguturi15@gmail.com");
        driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("Poojitha@3");
    ...
    public static void screenshot() throws IOException {
        ...
        driver.get("https://github.com/VYSHNAVIPOOJITHA/FinalProject/tree/master/src/main/java/org/example");
    ...
    public static void promptalert() throws Exception
    {
        ...
        System.out.println(driver.switchTo().alert().getText());
        Thread.sleep(2000);
        driver.switchTo().alert().sendKeys("VYSHNAVIPOOJITHA");
        driver.switchTo().alert().accept();
        Thread.sleep(2000);
        System.out.println(driver.findElement(By.id("output")).getText());
        driver.findElement(By.id("promptBox")).click();
